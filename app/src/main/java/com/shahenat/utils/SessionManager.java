...
import com.shahenat.SplashActivity;
...
public class SessionManager {
    ...
    public static final String PREF_NAME = "Shahenat";
   ...
   /* public static void Logout(String id, Context context) {
        ShahenatInterface apiInterface = ApiClient.getClient().create(ShahenatInterface.class);
