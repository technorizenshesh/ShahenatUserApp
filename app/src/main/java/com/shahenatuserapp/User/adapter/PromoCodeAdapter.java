...
public class PromoCodeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public PromoCodeAdapter(Context context, ArrayList<CategoryModel> modelList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.itme_promo_code, viewGroup, false);
