...
public class RideHistoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public RideHistoryAdapter(Context context, ArrayList<CategoryModel> modelList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.itme_ride_history, viewGroup, false);
